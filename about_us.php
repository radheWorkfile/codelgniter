...
<?php include('include/header.php');?>
    <main>
        ...
        <section class="section position-relative" style="background-image: url(image/image-1920x900-7.jpg);">
            ...
            <h4 class="text-cark font-1 lh-1 fw-semibold text-anim text_dark line-height"><span class="mission-man">Our Mission</span></h4>
            <p class="text-gray text-justify m-top-1" data-aos="fade-up" data-aos-duration="1000">Our mission is to develop and expand opportunities for each condidate and all to have excellent and pleasent nursing facilities and experiences. We are working in the direction of making a healthy society full of hopes for the future.We believe in our team and we will achieve our goal on time with your blessings and our hard work.</p>

            <h4 class="text-cark font-1 lh-1 fw-semibold text-anim text_dark line-height-1"><span class="mission-man">Our Vision</span></h4>
            <p class="text-gray text-justify m-top-1" data-aos="fade-up" data-aos-duration="1000">The vision of Aryaman College of Higher Studies is to empower students with exceptional education, fostering innovation, leadership, and excellence in healthcare, while preparing them to make a positive global impact through compassionate, skilled professional practices.</p>
