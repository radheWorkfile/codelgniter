	...
	<div class="container mt-lg-5 mt-3">
		<div class="row text-center">
			...
			<div class="col-md-5 mb-3">
				...
				<p class="text-red">E-Mail : <a href="mailto:ranpc06@gmail.com"><?php echo $email;?></a></p>
				
				<p class="text-red" ><i class="fas fa-phone fa-rotate-90 px-2 "></i>+91 <?php echo $mobile_1;?></p>
				<p class="text-red"><i class="fas fa-phone fa-rotate-90 px-2 "></i>+91 <?php echo $mobile_2;?></p>
			</div>
			<div class="col-md-3">
...
<section class="contact mt-5" id="contact">
		<div class="container pb-xl-5 pb-lg-3">
			<div class="row mx-sm-0 mx-2">
				...
				<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3604.9579124451607!2d85.349062!3d25.372727000000005!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xae5b7c9a557dfd5d!2sRaj+Aryan+Nursing+%26+paramedical+college!5e0!3m2!1sen!2sus!4v1561552086012!5m2!1sen!2sus" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
				</div>
				<!-- //map -->
				<!-- contact form -->
					...
					<div class="form-w3ls p-md-5 p-4">
						...
						<form action="formhandler.php" method="post">
							...
							<div class="input-group1 text-right">
								<button class="btn btn-sm mt-0 py-2 w-100" name="submit_contact" id="submit_contact" type="submit">Submit</button>
							</div>
						</form>
					</div>
				</div>
