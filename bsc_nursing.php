    ...
    <title>B. S. C. Nursing | <?php echo $heading;?></title>
    ...
    <?php include('include/header.php');?>
         ...
         <div class="site-breadcrumb cus-width" style="background: url(assets/images/bg/anm_banner.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title wow fadeInLeft" data-wow-delay=".50s"> B. S. C. Nursing </h2>
                <ul class="breadcrumb-menu">
                    <li><a href="index.php">Home</a></li>
                    <li class="active">B. S. C. Nursing</li>
                </ul>
            </div>
        </div>
        <!-- breadcrumb end -->
