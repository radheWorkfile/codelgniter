    ...
    <?php include('include/header.php');?>
         ...
         <div class="site-breadcrumb cus-width" style="background: url(assets/images/bg/anm_banner.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title wow fadeInLeft cus-font" data-wow-delay="1s"> B. O. T.  [ Bachelor of Occupational Therapy ]</h2>
        ...
        <div class="container">
            <h2 class="site-title wow fadeInLeft" data-wow-delay="1s" style="font-size: 35px;">B. O. T.<span> [ Bachelor of Occupational Therapy ]</span> </h2>
            ...
            <div class="col-lg-4">
                ...
                <div class="about-img">
                    <div class="row g-4">
                    <div class="col-md-6 pt-2 wow fadeInRight" data-wow-delay="1s" style="width: 100%">
