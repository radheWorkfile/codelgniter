                ...
                <div class="card-img-overlay">
                    <div class="row" >
                        <div class="col-lg-9 col-sm-11 text-center ">
                            <h3 class="card-title">Bachelor In Hospital Management</h3><br>
            ...
            <div class="container mt-lg-5 mt-3 pl-lg-4">
                <div class="row">
                    <div class="col-md-5 bg-doctor">
                            ...
                            <h5 class="m-4 d-none d-lg-block special-font text-light text-center">Best College For Bachelor In Hospital Management/h5>
                    </div>
                    <div class="col-md-7">
                        <h4 class="text-danger">Bachelor In Hospital Management</h4>
                        <p class="text-justify text-dark">Bachelor of Hospital Management or BHM is an undergraduate program of 4 years. The course focuses on aspects of management of healthcare services in hospitals, nursing homes, clinics, diagnostic centres and other institutions related to the healthcare industry. Topics on how hospitals function, administered and the various facilities managed, form the crux of the learning. Some of the important topics of the BHM Syllabus are - Principles of Management, Hospitals Operations, Healthcare Economics, Quality Management, Human Resource Management, Medical Ethics and Financial Management.</p>
                        <p><strong class="strng">DURATION:</strong><b> 4 YEARS. (6 MONTH INTERNSHIP)</b></p>
                    </div>
                </div>
            </div>
            <div class="container mt-5 pr-lg-4">
                <div class="row">
                    <div class="col-md-8">
                            <table class="table table-hover">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <th scope="row">4</th>
                                        <td>Good communication and observation skills which are crucial to good Hospital Management</td>
                                      </tr>
                                      <tr>
                                        <th scope="row">5</th>
                    ...
                    <div class="col-md-4 bg-doctor">
                        ...
                        <h5 class="m-4 d-none d-lg-block special-font text-light text-center">Bachelor In Hospital Management Objective</h5>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-5 eligibility">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                <th scope="row">3</th>
                                <td>Candidates  have any stram (english must) subjects in their 10+2 education.</td>
                                </tr>
                            </tbody>
                    </table>
                    </div>
