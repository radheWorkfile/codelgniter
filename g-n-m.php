                ...
                <div class="card-img-overlay">
                    <div class="row" >
                        ...
                        <div class="col-lg-6 col-sm-11 text-center ">
                                <h3 class="card-title">G. N. M. [General Nursing &amp; Midwifery]</h3>
                    ...
                    <div class="col-md-8">
                            <table class="table table-hover">
                                    ...
                                    <tbody>
                                      <tr>
                                        <th scope="row">1</th>
                                        <td>The program has been designed to enable eligible candidates to address the health needs of the country, community, and individuals. They can also pursue advanced study and specialization in nursing while contributing to the health-based industry with patience, responsibility, and dedication</td>
                                      </tr>
                                      <tr>
                                        <th scope="row">2</th>
                                        <td>Leadership skills, determination, tenacity, and ability to conduct research</td>
                                      </tr>
                                      <tr>
                                        <th scope="row">3</th>
                                        <td>Ideal candidates for the course would possess alertness of mind, team spirit, tact, compassion, and physical fitness. Such professionals interested in pursuing higher studies in the discipline may go for higher degree programs in the subject.</td>
                                      </tr>
                                    </tbody>
                                  </table>
                    </div>
                    <div class="col-md-4 bg-doctor">
                        <img src="images/course.jpg" alt="GNM Objective" class="img-fluid w-100">
                        <h5 class="text-light text-center special-font mt-4  d-none d-lg-block">G. N. M. Objective</h5>
                    </div>
                </div>
            </div>
