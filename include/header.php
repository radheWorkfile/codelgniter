                ...
                <div class="header-top-wrap">
                    ...
                    <div class="header-top-right">
                        <div class="header-top-contact">
                            <ul>
                                <li>
                                    <a href="<?php echo $call;?>"><i class="far fa-phone-volume"></i> <?php echo $mobile_1.' | '.$mobile_2;?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-4 col-md-4">
                                                    ...
                                                    <ul class="mega-menu-item">
                                                        ...
                                                        <li><a class="dropdown-item" href="bsc_nursing.php">B. Sc. Nursing</a> </li>
                                                        <li><a class="dropdown-item" href="pbbsc_nursing.php">P. B. B. Sc. Nursing</a></li>
                                                        <li><a class="dropdown-item  border-bottom_new" href="msc_nursing.php">M. Sc. Nursing</a></li>
                                                    </ul>
                                                </div>
                                                <div class="col-12 col-sm-4 col-md-4">
                                                    <ul class="mega-menu-item">
                                                        <li><a class="dropdown-item" href="dresser.php">Dresser</a></li>
                                                        <li><a class="dropdown-item" href="dmlt_course.php">D. M. L. T.</a></li>
                                                        <li><a class="dropdown-item" href="ot_assistant.php">O. T. Assistant</a></li>
                                                        <li><a class="dropdown-item" href="dpt_course.php">D. P. T.</a></li>
                                                        <li><a class="dropdown-item border-bottom_new" href="doct_course.php">D. O. C. T.</a></li>
                                                    </ul>
                                                </div>
