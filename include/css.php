        ...
        <!-- Main area of website start from here.  -->
        <style>
        *{ transition: all 0.1s ease; }
        :root { --primary: #0077ff; --bg:#f0f0f0; --text: #333; }
        body { font-family: 'Inter', sans-serif; line-height: 1.6;font-size: 16px; color: #333;
        margin: 0; padding: 0; background-color: var(--bg); color: var(--text); }
        html { scroll-behavior: smooth; }
        .element { will-change: transform, opacity; }
        </style>
        <!-- Main area of website end here.  -->
