  ...
  <?php include('default.php');?>
    ...
    <p class="text-white text-center">@copy right: all right reserved by camwel solution</p>
    </div>
    </div>
    </div>
    </section>
    ...
    @media (max-width: 600px) {.cus-desk-menu {display: none;}
    .custom-mob-menu {display: block;}}
