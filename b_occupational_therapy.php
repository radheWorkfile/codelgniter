            ...
            <div class="card-img-overlay">
                <div class="row" >
                    <div class="col-lg-9 col-sm-11 text-center ">
                        <h3 class="card-title">Bachelor In Occupational Therapy</h3><br>
            ...
            <div class="container mt-lg-5 mt-3 pl-lg-4">
                <div class="row">
                    <div class="col-md-5 bg-doctor">
                            ...
                            <h5 class="m-4 d-none d-lg-block special-font text-light text-center">Best College For Bachelor In Occupational Therapy</h5>
                    </div>
                    <div class="col-md-7">
                        <h4 class="text-danger">Bachelor In Occupational Therapy</h4>
                        <p class="text-justify text-dark">Bachelor of Occupational Therapy is a 4-year undergraduate course designed to produce efficient Occupational Therapists who can help the treatment of physically or mentally challenged people. They are responsible for conducting therapeutic treatment so that the patients can enjoy their life without any hindrance.
                        The admission to the Bachelor in Occupational Therapy courses is done on the basis of either merit list or entrance examination. The minimum eligibility criteria for admission to the course is that the candidates must be from the science stream and should have passed their 12th with 50% score.
                        </p>
                ...
                <div class="row">
                    <div class="col-md-8">
                            <table class="table table-hover">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <th scope="row">4</th>
                                        <td>Good communication and observation skills which are crucial to good Occupational Therapy</td>
                                      </tr>
                                      <tr>
                                        <th scope="row">5</th>
                    ...
                    <div class="col-md-4 bg-doctor">
                        <img src="images/course.jpg" alt="Aims" class="img-fluid">
                            <h5 class="m-4 d-none d-lg-block special-font text-light text-center">Bachelor In Occupational Therapy Objective</h5>
                    </div>
                </div>
            </div>
