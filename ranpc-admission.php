...
<body>
	...
	<div class="container-fluid p-0">
			<div class="card bg-light text-danger banner">
				<img class="card-img img-fluid" src="images/adm-banner.jpg" alt="Card image">
		...
		<section>
				<div class="container-fluid p-0 ">
					<div class="container mt-lg-5 mt-3">
						<div class="row">
							<div class="col-md-8">
									<h3 class="text-red mb-4 special-font">Eligibility & Selection Criteria</h3>
									<p class="text-justify text-dark">Candidates having passed at least intermediate (10+2 equivalents) from any recognized board / university and who are minimum of 15 years and maximum of 35 years of age are eligible for admission.</p>
							</div>
							<div class="col-md-4">
