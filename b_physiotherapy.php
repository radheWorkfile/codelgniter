                ...
                <div class="card-img-overlay">
                    <div class="row" >
                        <div class="col-lg-9 col-sm-11 text-center ">
                                <h3 class="card-title">Bachelor In Physiotherapy</h3><br>
                ...
                <div class="row">
                    <div class="col-md-8">
                            <table class="table table-hover">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <th scope="row">4</th>
                                        <td>Good communication and observation skills which are crucial to goodPhysiotherapy</td>
                                      </tr>
                                      <tr>
                                        <th scope="row">5</th>
                    ...
                    <div class="col-md-4 bg-doctor">
                        <img src="images/course.jpg" alt="Aims" class="img-fluid">
                            <h5 class="m-4 d-none d-lg-block special-font text-light text-center">Bachelor In Physiotherapy Objective</h5>
                    </div>
                </div>
            </div>
