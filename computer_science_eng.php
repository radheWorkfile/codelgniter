...
<head>
  <title>Computer Science Engineering || Aryaman Higher Education</title>
  <!-- Meta tag Keywords -->
...
<body>
      ...
      <div class="card-img-overlay">
        <div class="row">
          <div class="col-lg-10 col-sm-11 text-center ">
            <h3 class="card-title"> C. S. E.  [ Computer Science Engineering ]</h3><br>
  ...
  <main>
    <section><?php include("include/sideform.php"); ?> </section>
    <section CLASS="mb-5">
      <div class="container-fluid p-0 ">
        <div class="container mt-lg-5 mt-3 pl-lg-4">
          <div class="row">
            <div class="col-md-5 bg-doctor">
              <img class="img-fluid " src="images/nursing/cse-img-1.jpg" alt="Course">
              <h5
                ...
                Best Computer Science Engineering College In BIHAR</h5>
            </div>
            <div class="col-md-7">
              <h4 class="text-danger special-font mb-3 wow animate__ animate__zoomIn  animated" data-wow-delay="0.5s"
                data-wow-duration="1.5s">C. S. E.  [ Computer Science Engineering ]</h4>
              <p class="text-justify text-dark wow animate__ animate__zoomIn  animated" data-wow-delay="0.5s"
                data-wow-duration="1.5s">Computer Science Engineering (CSE) is the engineering specialty focused on the study of computers, computational systems, and software development. It is a profession that emphasizes designing, developing, and maintaining computer applications and systems for various industries. CSE is an important part of the technology and innovation sector. Computer engineers have the responsibility to ensure the smooth functioning of digital systems across organizations such as IT companies, research labs, startups, government sectors, and more. Subjects covered within this course's curriculum include Programming Languages, Data Structures, Algorithms,</p>
            </div>
          </div>
        </div>
        <div class="container mt-5 pr-lg-4">
          <div class="row">
            ...
            <div class="col-md-4 bg-doctor">
              <img src="images/nursing/cse-img-2.jpg" alt="Aims" class="img-fluid">
              <h5 class="m-4 d-none d-lg-block special-font text-light text-center">C. S. E. Objective</h5>
            </div>
          </div>
        </div>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <tr class="wow animate__ animate__zoomIn  animated" data-wow-delay="0.5s" data-wow-duration="1.5s">
                    ...
                    <td>
                      <p class="text-red font-weight-bold">Computer Science Engineering</p>
                    </td>
                    <td class="d-none">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <tr class="wow animate__ animate__zoomIn  animated" data-wow-delay="0.5s" data-wow-duration="1.5s">
                    <th scope="row">1</th>
                    <td>
                      Successful completion of the 10+2 level of education, from a
                  ...
                  <tr class="wow animate__ animate__zoomIn  animated" data-wow-delay="0.5s" data-wow-duration="1.5s">
                    <th scope="row">2</th>
                    <td>
                      A minimum aggregate score of 45% (40% for SC/ST candidates) at the
                      10+2 level.
                    </td>
                  </tr>
                  <tr class="wow animate__ animate__zoomIn  animated" data-wow-delay="0.5s" data-wow-duration="1.5s">
        ...
        <div class="container mt-5">
          <div class="row">
            <div class="col-md-12 admission-process">
              <table class="table table-hover">
                <thead>
                  <tr class="text-center bg-danger text-light">
                ...
                <tbody>
                  <tr class="wow animate__ animate__zoomIn  animated" data-wow-delay="0.5s" data-wow-duration="1.5s">
                    <th scope="row">1</th>
                    <td>Most colleges offering CSE select students based on entrance exam scores and a personal interview, which checks how well the student fits the course. The process may differ from college to college, but final admission depends on how well the student performs in both.</td>
                  </tr>
                  <tr class="wow animate__ animate__zoomIn  animated" data-wow-delay="0.5s" data-wow-duration="1.5s">
                    <th scope="row">2</th>
                    <td>Few institutes also provide direct admission based on the candidate's performance at the 10+2
                      level.</td>
                  </tr>
                </tbody>
              </table>
