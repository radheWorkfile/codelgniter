                ...
                <div class="card-img-overlay">
                    <div class="row" >
                        <div class="col-lg-9 col-sm-11 text-center ">
                                <h3 class="card-title">Diploma in Occupational Therapy</h3><br>
            ...
            <div class="container mt-lg-5 mt-3 pl-lg-4">
                <div class="row">
                    <div class="col-md-5 bg-doctor">
                            ...
                            <h5 class="m-4 d-none d-lg-block special-font text-light text-center">Best College For Diploma in Occupational Therapy</h5>
                    </div>
                    <div class="col-md-7">
                        <h4 class="text-danger">Diploma in Occupational Therapy</h4>
                        <p class="text-justify text-dark">Diploma in Occupational Therapy is a Diploma level Occupational Therapy course. Occupational therapists use activities to facilitate human performance and improve health. They can specialize in varied areas such as in the case of children with learning disabilities, occupational therapists employ activities which develop sensory integration, thinking, writing and social skills so that they can function within the school environment. The course is career orienting in nature that provides many jobs after its successful completion both in private and government sectors.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 bg-doctor">
                        <img src="images/course.jpg" alt="Aims" class="img-fluid">
                            <h5 class="m-4 d-none d-lg-block special-font text-light text-center">Diploma in Occupational Therapy Objective</h5>
                    </div>
                </div>
            </div>
