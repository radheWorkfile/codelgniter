<footer class="page-footer">
	...
	format: 'dd-mm-yyyy'
		...
		oprType: getData[0], id: getData[2]
		}, function (htmlAmi) {
		$('#cnfChanges').html('Confirm Delete <i class="fa-solid fa-trash-can"></i>');
		if (htmlAmi.action == 'success') {setTimeout(function () {
		$('#deletePanel').modal('hide');window.location.reload(1)
		}, 2000);}
	...
	let getData = actNbtn.split('===');
		...
		window.location.href = htmlAmi.reloadPage; }, 2500); }
		else { $('#statusChange').delay(3000).modal('hide'); }
		}, 'json');
      }
    });
  });
